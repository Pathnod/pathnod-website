    ...
    <main id="main">
      ...
      <section id="approach" className="approach-section">
        <div className="shell">
          ...
          <div className="approach-heading"><h2>A different kind of<br /><em>field evidence.</em></h2><p>Built around local interaction, independent witnesses and measured confidence—not a single “verified location” claim.</p></div>
          <div className="steps">
            <article className="step"><span className="step-index">01 / DISCOVER</span><div className="step-symbol" aria-hidden="true">◎</div><h3>A phone passes nearby</h3><p>A participating phone detects a registered device's Bluetooth service when it comes within radio range.</p></article>
            <article className="step"><span className="step-index">02 / CHALLENGE</span><div className="step-symbol" aria-hidden="true">⌁</div><h3>The device responds</h3><p>A fresh challenge asks the device to sign a response with its own key, linking the observation to that device.</p></article>
            <article className="step"><span className="step-index">03 / CORROBORATE</span><div className="step-symbol" aria-hidden="true">✳</div><h3>Signals add up</h3><p>Multiple observations can give operators a stronger, auditable signal than self-reporting alone.</p></article>
          </div>
